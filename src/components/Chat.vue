...
const init = () => {
  ...
  if (typeof (WebSocket) == "undefined") {
    ...
    // 区分线上和开发环境
    let socketUrl = process.env.NODE_ENV !== "development" ? `https://roquet-backend-83783-6-1322971161.sh.run.tcloudbase.com/api/websocket/${uid}/${stats.value.team.teamId}`
